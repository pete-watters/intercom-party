export default function() {
  this.get('/customers', function() {
    // TODO - this should do the JSON call to the .json file
    //      - I was attempting to do this a few ways, see mixins/load-json.js
    //      - I made a decision to just load the data manually as I was getting conflicts between Mirage faking an API and getting a local file
    //      - I am aware none of this is part of the brief but I do love Ember and playing so I got a bit of tunnel vision :)
    ...
    var rawCustomerData = { "customers" : [
                ...
                var customerDataRecordCount = rawCustomerData.customers.length -1;
                ...
                for(var customerRecordIterationCount = 0; customerRecordIterationCount  < customerDataRecordCount; customerRecordIterationCount++){
                        customerDataArray.push({
                          ...
                          type: 'customer',
                          attributes: rawCustomerData.customers[customerRecordIterationCount]
                        });
                }

                var arrayToLoadIntoEmberData = {data : customerDataArray};

                return arrayToLoadIntoEmberData;
  });
}
